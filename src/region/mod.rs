...
impl std::fmt::Debug for DbUpdate {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut debug_struct = f.debug_struct("DbUpdate");

        // Helper macro to add field only if TableUpdate is not empty
        macro_rules! add_if_not_empty {
            ($field:ident) => {
                if !self.$field.inserts.is_empty() || !self.$field.deletes.is_empty() {
                    debug_struct.field(stringify!($field), &self.$field);
                }
            };
        }

        add_if_not_empty!(a_i_debug_state);
        add_if_not_empty!(achievement_desc);
        add_if_not_empty!(action_state);
        add_if_not_empty!(active_buff_state);
        add_if_not_empty!(admin_broadcast);
        add_if_not_empty!(admin_clear_resource_timer);
        add_if_not_empty!(admin_restore_player_state_timer);
        add_if_not_empty!(alert_desc);
        add_if_not_empty!(alert_state);
        add_if_not_empty!(attached_herds_state);
        add_if_not_empty!(attack_impact_timer);
        add_if_not_empty!(attack_outcome_state);
        add_if_not_empty!(attack_timer);
        add_if_not_empty!(auto_claim_state);
        add_if_not_empty!(auto_logout_loop_timer);
        add_if_not_empty!(barter_stall_state);
        add_if_not_empty!(biome_desc);
        add_if_not_empty!(blocked_identity);
        add_if_not_empty!(buff_desc);
        add_if_not_empty!(buff_type_desc);
        add_if_not_empty!(building_claim_desc);
        add_if_not_empty!(building_decay_loop_timer);
        add_if_not_empty!(building_desc);
        add_if_not_empty!(building_despawn_timer);
        add_if_not_empty!(building_function_type_mapping_desc);
        add_if_not_empty!(building_nickname_state);
        add_if_not_empty!(building_portal_desc);
        add_if_not_empty!(building_repairs_desc);
        add_if_not_empty!(building_spawn_desc);
        add_if_not_empty!(building_state);
        add_if_not_empty!(building_type_desc);
        add_if_not_empty!(buy_order_state);
        add_if_not_empty!(cargo_desc);
        add_if_not_empty!(character_stat_desc);
        add_if_not_empty!(character_stats_state);
        add_if_not_empty!(chat_cleanup_timer);
        add_if_not_empty!(chat_message_state);
        add_if_not_empty!(chest_rarity_desc);
        add_if_not_empty!(claim_local_state);
        add_if_not_empty!(claim_member_state);
        add_if_not_empty!(claim_recruitment_state);
        add_if_not_empty!(claim_state);
        add_if_not_empty!(claim_tech_desc);
        add_if_not_empty!(claim_tech_state);
        add_if_not_empty!(claim_tech_unlock_timer);
        add_if_not_empty!(claim_tile_cost);
        add_if_not_empty!(claim_tile_state);
        add_if_not_empty!(climb_requirement_desc);
        add_if_not_empty!(closed_listing_state);
        add_if_not_empty!(clothing_desc);
        add_if_not_empty!(collect_stats_timer);
        add_if_not_empty!(collectible_desc);
        add_if_not_empty!(combat_action_desc);
        add_if_not_empty!(combat_state);
        add_if_not_empty!(config);
        add_if_not_empty!(construction_recipe_desc);
        add_if_not_empty!(crafting_recipe_desc);
        add_if_not_empty!(day_night_loop_timer);
        add_if_not_empty!(deconstruction_recipe_desc);
        add_if_not_empty!(deployable_collectible_state);
        add_if_not_empty!(deployable_desc);
        add_if_not_empty!(deployable_dismount_timer);
        add_if_not_empty!(deployable_state);
        add_if_not_empty!(destroy_dimension_network_timer);
        add_if_not_empty!(developer);
        add_if_not_empty!(dimension_description_state);
        add_if_not_empty!(dimension_network_state);
        add_if_not_empty!(distant_visible_entity);
        add_if_not_empty!(distant_visible_entity_desc);
        add_if_not_empty!(dropped_inventory_despawn_timer);
        add_if_not_empty!(dropped_inventory_ownership_timer);
        add_if_not_empty!(dropped_inventory_state);
        add_if_not_empty!(duel_agent_timer);
        add_if_not_empty!(duel_despawn_timer);
        add_if_not_empty!(duel_state);
        add_if_not_empty!(elevator_desc);
        add_if_not_empty!(emote_desc);
        add_if_not_empty!(empire_chunk_state);
        add_if_not_empty!(empire_color_desc);
        add_if_not_empty!(empire_expansion_state);
        add_if_not_empty!(empire_icon_desc);
        add_if_not_empty!(empire_node_siege_state);
        add_if_not_empty!(empire_node_state);
        add_if_not_empty!(empire_notification_desc);
        add_if_not_empty!(empire_player_data_state);
        add_if_not_empty!(empire_rank_desc);
        add_if_not_empty!(empire_rank_state);
        add_if_not_empty!(empire_settlement_state);
        add_if_not_empty!(empire_state);
        add_if_not_empty!(empire_supplies_desc);
        add_if_not_empty!(empire_territory_desc);
        add_if_not_empty!(end_grace_period_timer);
        add_if_not_empty!(enemy_ai_params_desc);
        add_if_not_empty!(enemy_desc);
        add_if_not_empty!(enemy_despawn_timer);
        add_if_not_empty!(enemy_mob_monitor_state);
        add_if_not_empty!(enemy_regen_loop_timer);
        add_if_not_empty!(enemy_state);
        add_if_not_empty!(environment_debuff_desc);
        add_if_not_empty!(environment_debuff_loop_timer);
        add_if_not_empty!(equipment_desc);
        add_if_not_empty!(equipment_state);
        add_if_not_empty!(experience_state);
        add_if_not_empty!(exploration_chunks_state);
        add_if_not_empty!(extract_outcome_state);
        add_if_not_empty!(extraction_recipe_desc);
        add_if_not_empty!(food_desc);
        add_if_not_empty!(footprint_tile_state);
        add_if_not_empty!(force_generate_types);
        add_if_not_empty!(gate_desc);
        add_if_not_empty!(global_search_state);
        add_if_not_empty!(globals);
        add_if_not_empty!(growth_loop_timer);
        add_if_not_empty!(growth_state);
        add_if_not_empty!(health_state);
        add_if_not_empty!(herd_state);
        add_if_not_empty!(hexite_exchange_entry_desc);
        add_if_not_empty!(hide_deployable_timer);
        add_if_not_empty!(identity_role);
        add_if_not_empty!(inter_module_message);
        add_if_not_empty!(inter_module_message_counter);
        add_if_not_empty!(inter_module_response_message_counter);
        add_if_not_empty!(interior_collapse_trigger_state);
        add_if_not_empty!(interior_environment_desc);
        add_if_not_empty!(interior_instance_desc);
        add_if_not_empty!(interior_network_desc);
        add_if_not_empty!(interior_portal_connections_desc);
        add_if_not_empty!(interior_set_collapsed_timer);
        add_if_not_empty!(interior_shape_desc);
        add_if_not_empty!(interior_spawn_desc);
        add_if_not_empty!(inventory_state);
        add_if_not_empty!(item_conversion_recipe_desc);
        add_if_not_empty!(item_desc);
        add_if_not_empty!(item_list_desc);
        add_if_not_empty!(knowledge_achievement_state);
        add_if_not_empty!(knowledge_battle_action_state);
        add_if_not_empty!(knowledge_building_state);
        add_if_not_empty!(knowledge_cargo_state);
        add_if_not_empty!(knowledge_claim_state);
        add_if_not_empty!(knowledge_construction_state);
        add_if_not_empty!(knowledge_craft_state);
        add_if_not_empty!(knowledge_deployable_state);
        add_if_not_empty!(knowledge_enemy_state);
        add_if_not_empty!(knowledge_extract_state);
        add_if_not_empty!(knowledge_item_state);
        add_if_not_empty!(knowledge_lore_state);
        add_if_not_empty!(knowledge_npc_state);
        add_if_not_empty!(knowledge_paving_state);
        add_if_not_empty!(knowledge_pillar_shaping_state);
        add_if_not_empty!(knowledge_resource_placement_state);
        add_if_not_empty!(knowledge_resource_state);
        add_if_not_empty!(knowledge_ruins_state);
        add_if_not_empty!(knowledge_scroll_desc);
        add_if_not_empty!(knowledge_scroll_type_desc);
        add_if_not_empty!(knowledge_secondary_state);
        add_if_not_empty!(knowledge_stat_modifier_desc);
        add_if_not_empty!(knowledge_vault_state);
        add_if_not_empty!(light_source_state);
        add_if_not_empty!(location_cache);
        add_if_not_empty!(location_state);
        add_if_not_empty!(loot_chest_desc);
        add_if_not_empty!(loot_chest_despawn_timer);
        add_if_not_empty!(loot_chest_spawn_timer);
        add_if_not_empty!(loot_chest_state);
        add_if_not_empty!(loot_rarity_desc);
        add_if_not_empty!(loot_table_desc);
        add_if_not_empty!(lost_items_state);
        add_if_not_empty!(mobile_entity_state);
        add_if_not_empty!(moderation_action_log_entry);
        add_if_not_empty!(mounting_state);
        add_if_not_empty!(move_validation_strike_counter_state);
        add_if_not_empty!(npc_ai_loop_timer);
        add_if_not_empty!(npc_desc);
        add_if_not_empty!(npc_state);
        add_if_not_empty!(on_durability_zero_timer);
        add_if_not_empty!(onboarding_reward_desc);
        add_if_not_empty!(onboarding_state);
        add_if_not_empty!(parameters_desc);
        add_if_not_empty!(parameters_player_move_desc);
        add_if_not_empty!(partial_experience_state);
        add_if_not_empty!(passive_craft_state);
        add_if_not_empty!(passive_craft_timer);
        add_if_not_empty!(pathfinding_desc);
        add_if_not_empty!(paved_tile_state);
        add_if_not_empty!(paving_tile_desc);
        add_if_not_empty!(permission_state);
        add_if_not_empty!(pillar_shaping_desc);
        add_if_not_empty!(pillar_shaping_state);
        add_if_not_empty!(player_action_desc);
        add_if_not_empty!(player_action_state);
        add_if_not_empty!(player_death_timer);
        add_if_not_empty!(player_housing_desc);
        add_if_not_empty!(player_housing_evict_player_timer);
        add_if_not_empty!(player_housing_income_loop_timer);
        add_if_not_empty!(player_housing_state);
        add_if_not_empty!(player_lowercase_username_state);
        add_if_not_empty!(player_note_state);
        add_if_not_empty!(player_notification_event);
        add_if_not_empty!(player_prefs_state);
        add_if_not_empty!(player_queue_state);
        add_if_not_empty!(player_regen_loop_timer);
        add_if_not_empty!(player_region_transfer_event);
        add_if_not_empty!(player_report_state);
        add_if_not_empty!(player_report_state_timestamp);
        add_if_not_empty!(player_set_name_outcome_event);
        add_if_not_empty!(player_state);
        add_if_not_empty!(player_timestamp_state);
        add_if_not_empty!(player_use_elevator_timer);
        add_if_not_empty!(player_username_state);
        add_if_not_empty!(player_vote_conclude_timer);
        add_if_not_empty!(player_vote_state);
        add_if_not_empty!(portal_state);
        add_if_not_empty!(private_parameters_desc);
        add_if_not_empty!(progressive_action_state);
        add_if_not_empty!(project_site_state);
        add_if_not_empty!(public_progressive_action_state);
        add_if_not_empty!(region_connection_info);
        add_if_not_empty!(region_population_info);
        add_if_not_empty!(region_popuplation_loop_timer);
        add_if_not_empty!(region_sign_in_parameters);
        add_if_not_empty!(rent_collector_loop_timer);
        add_if_not_empty!(rent_evict_timer);
        add_if_not_empty!(rent_state);
        add_if_not_empty!(reserved_name_desc);
        add_if_not_empty!(reset_chunk_index_timer);
        add_if_not_empty!(reset_mobile_entity_timer);
        add_if_not_empty!(resource_clump_desc);
        add_if_not_empty!(resource_count);
        add_if_not_empty!(resource_desc);
        add_if_not_empty!(resource_growth_recipe_desc);
        add_if_not_empty!(resource_health_state);
        add_if_not_empty!(resource_placement_recipe_desc);
        add_if_not_empty!(resource_spawn_timer);
        add_if_not_empty!(resource_state);
        add_if_not_empty!(resources_log);
        add_if_not_empty!(resources_regen_loop_timer);
        add_if_not_empty!(respawn_resource_in_chunk_timer);
        add_if_not_empty!(rez_sick_long_term_state);
        add_if_not_empty!(satiation_state);
        add_if_not_empty!(secondary_knowledge_desc);
        add_if_not_empty!(sell_order_state);
        add_if_not_empty!(server_identity);
        add_if_not_empty!(signed_in_player_state);
        add_if_not_empty!(single_resource_clump_info);
        add_if_not_empty!(single_resource_to_clump_desc);
        add_if_not_empty!(skill_desc);
        add_if_not_empty!(staged_static_data);
        add_if_not_empty!(stamina_state);
        add_if_not_empty!(starving_loop_timer);
        add_if_not_empty!(starving_player_state);
        add_if_not_empty!(target_state);
        add_if_not_empty!(targetable_state);
        add_if_not_empty!(targeting_matrix_desc);
        add_if_not_empty!(teleport_item_desc);
        add_if_not_empty!(teleport_player_timer);
        add_if_not_empty!(teleportation_energy_regen_loop_timer);
        add_if_not_empty!(teleportation_energy_state);
        add_if_not_empty!(terraform_progress_state);
        add_if_not_empty!(terraform_recipe_desc);
        add_if_not_empty!(terrain_chunk_state);
        add_if_not_empty!(the_great_placeholder_table);
        add_if_not_empty!(threat_state);
        add_if_not_empty!(tool_desc);
        add_if_not_empty!(tool_type_desc);
        add_if_not_empty!(toolbar_state);
        add_if_not_empty!(trade_order_state);
        add_if_not_empty!(trade_session_loop_timer);
        add_if_not_empty!(trade_session_state);
        add_if_not_empty!(transfer_player_timer);
        add_if_not_empty!(traveler_task_desc);
        add_if_not_empty!(traveler_task_loop_timer);
        add_if_not_empty!(traveler_task_state);
        add_if_not_empty!(traveler_trade_order_desc);
        add_if_not_empty!(unclaimed_collectibles_state);
        add_if_not_empty!(unclaimed_shards_state);
        add_if_not_empty!(user_authentication_state);
        add_if_not_empty!(user_moderation_state);
        add_if_not_empty!(user_previous_region_state);
        add_if_not_empty!(user_state);
        add_if_not_empty!(vault_state);
        add_if_not_empty!(wall_desc);
        add_if_not_empty!(weapon_desc);
        add_if_not_empty!(weapon_type_desc);
        add_if_not_empty!(world_region_name_state);
        add_if_not_empty!(world_region_state);
